from Grafos.roteiro7.grafo_adj import *
from Grafos.roteiro7.grafo_adj_nao_dir import *
import unittest
...
class TestGrafo(unittest.TestCase):
    ...
    def test_busca_profundidade(self):
        self.assertEqual(self.nao_di.busca_prof_nao_dir(),(['A-B', 'B-G', 'G-F', 'F-H', 'H-C', 'C-D', 'D-E', 'B-I', 'I-J', 'J-K'], ['H-A', 'H-B', 'E-H', 'D-H', 'J-A', 'J-B', 'K-B']))
        self.assertEqual(self.nao_di2.busca_prof_nao_dir(),(['A-B', 'B-C', 'C-D', 'D-E', 'B-F', 'F-G', 'G-H', 'H-I', 'I-J', 'J-K'], ['D-B', 'E-B', 'H-A', 'H-B', 'J-A', 'J-H', 'K-H']))
        self.assertEqual(self.dire.busca_profundidade_dir(),(['A-B', 'A-D', 'A-G', 'G-C', 'G-E', 'E-F', 'H-I', 'I-L', 'I-M'], ['G-C', 'F-G', 'M-H'], ['C-B', 'C-D', 'E-D', 'H-C', 'M-L', 'J-I', 'K-I', 'K-J', 'K-L']))
        self.assertEqual(self.dire2.busca_profundidade_dir(),(['A-B', 'B-C', 'C-D', 'C-E', 'B-F', 'F-G', 'H-I', 'I-J', 'J-K', 'J-L'], ['E-B', 'B-F', 'A-D', 'A-G', 'K-I', 'I-L'], ['F-D', 'K-F', 'M-H', 'M-I', 'M-L']))